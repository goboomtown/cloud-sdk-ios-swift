//
// ReportingKPIAverageTimeToScheduledResponse.swift
//
...
open class ReportingKPIAverageTimeToScheduledResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIAverageTimeToScheduledResponseResults]?
