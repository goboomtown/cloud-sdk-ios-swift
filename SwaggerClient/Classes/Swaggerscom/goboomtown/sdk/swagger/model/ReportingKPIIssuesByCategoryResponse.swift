//
// ReportingKPIIssuesByCategoryResponse.swift
//
...
open class ReportingKPIIssuesByCategoryResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesByCategoryResponseResults]?
