//
// ReportingKPIIssuesRemoteVsOnsiteResponse.swift
//
...
open class ReportingKPIIssuesRemoteVsOnsiteResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesRemoteVsOnsiteResponseResults]?
