//
// ReportingKPITimeOnsiteByLocationResponse.swift
//
...
open class ReportingKPITimeOnsiteByLocationResponse: JSONEncodable {
    ...
    public var results: [ReportingKPITimeOnsiteByLocationResponseResults]?
