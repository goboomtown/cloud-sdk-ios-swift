//
// ReportingKPIIssuesOverTimeResponse.swift
//
...
open class ReportingKPIIssuesOverTimeResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesOverTimeResponseResults]?
