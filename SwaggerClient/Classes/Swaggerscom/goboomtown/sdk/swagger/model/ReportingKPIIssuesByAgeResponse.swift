//
// ReportingKPIIssuesByAgeResponse.swift
//
...
open class ReportingKPIIssuesByAgeResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesByAgeResponseResults]?
