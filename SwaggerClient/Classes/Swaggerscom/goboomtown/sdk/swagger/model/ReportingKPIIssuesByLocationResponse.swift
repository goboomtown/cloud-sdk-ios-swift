//
// ReportingKPIIssuesByLocationResponse.swift
//
...
open class ReportingKPIIssuesByLocationResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesByLocationResponseResults]?
