//
// ReportingKPIActiveSupportMinutesResponse.swift
//
...
open class ReportingKPIActiveSupportMinutesResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIActiveSupportMinutesResponseResults]?
