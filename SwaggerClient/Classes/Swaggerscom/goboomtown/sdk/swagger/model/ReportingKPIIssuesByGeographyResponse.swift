//
// ReportingKPIIssuesByGeographyResponse.swift
//
...
open class ReportingKPIIssuesByGeographyResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesByGeographyResponseResults]?
