//
// TechnologyDictionaryResponse.swift
//
...
open class TechnologyDictionaryResponse: JSONEncodable {
    ...
    /** Dictionary of ID to names. The &#x60;id&#x60; property is an example: it will actually be an ID of a type */
