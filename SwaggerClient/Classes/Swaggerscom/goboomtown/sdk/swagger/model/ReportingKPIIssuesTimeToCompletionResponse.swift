//
// ReportingKPIIssuesTimeToCompletionResponse.swift
//
...
open class ReportingKPIIssuesTimeToCompletionResponse: JSONEncodable {
    ...
    public var results: [ReportingKPIIssuesTimeToCompletionResponseResults]?
